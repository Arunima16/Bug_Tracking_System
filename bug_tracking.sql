...
(4, 'Short Navbar', 'The Navigation bar is extending to whole screen.', '','High', 'Work In Progress', 'QA_2'),
(6, 'New Bug', 'Bug Detected', '','Medium','Open', 'QA_1');
...
-- 
-- Alter table `bug` to add column priority and remove column comment
--
...
ALTER TABLE `bug` 
ADD `priority` varchar(25) NOT NULL;*/
